...
knitr::opts_chunk$set(echo=TRUE, message=FALSE, warning=FALSE, fig.align="left", fig.pos="H", digits=2)
...
(Please note, there is a file on my PC with my login credentials to Econdata that makes this run, that has been placed in the gitignore)
